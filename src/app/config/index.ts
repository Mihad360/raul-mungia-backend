...
const config = {
  ...
  FEDEX_API_BASE: process.env.FEDEX_API_BASE,
  ...
  // NEW — Track API credentials
  FEDEX_TRACK_CLIENT_ID: process.env.FEDEX_TRACK_CLIENT_ID,
  FEDEX_TRACK_CLIENT_SECRET: process.env.FEDEX_TRACK_CLIENT_SECRET,

  FREE_SHIPPING_ENABLED: process.env.FREE_SHIPPING_ENABLED === "true",
  FREE_SHIPPING_THRESHOLD: Number(process.env.FREE_SHIPPING_THRESHOLD) || 150,
  FREE_SHIPPING_SERVICE: process.env.FREE_SHIPPING_SERVICE || "FEDEX_GROUND",

  // FEDEX SHIPPER
  SHIPPER_NAME: process.env.SHIPPER_NAME,
  SHIPPER_COMPANY: process.env.SHIPPER_COMPANY,
  SHIPPER_PHONE: process.env.SHIPPER_PHONE,
  SHIPPER_EMAIL: process.env.SHIPPER_EMAIL,
  SHIPPER_STREET: process.env.SHIPPER_STREET,
  SHIPPER_CITY: process.env.SHIPPER_CITY,
  SHIPPER_STATE: process.env.SHIPPER_STATE,
  SHIPPER_POSTAL_CODE: process.env.SHIPPER_POSTAL_CODE,
